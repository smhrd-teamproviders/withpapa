         ...
         <!-- <form action="search/searchresult" method="get"> -->
            <div class="pop_content">
               ...
               <div class="scrollMenu">
                  <div>
                     <input type="radio" name="placeDistrict" value="거제시">거제시
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="거창군">거창군
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="고성군">고성군
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="김해시">김해시
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="남해군">남해군
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="밀양시">밀양시
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="사천시">사천시
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="산청군">산청군
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="양산시">양산시
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="의령군">의령군
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="진주시">진주시
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="창녕군">창녕군
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="창원시">창원시
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="통영시">통영시
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="하동군">하동군
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="함안군">함안군
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="함양군">함양군
                  </div>
                  <div>
                     <input type="radio" name="placeDistrict" value="합천군">합천군
                  </div>
               </div>
